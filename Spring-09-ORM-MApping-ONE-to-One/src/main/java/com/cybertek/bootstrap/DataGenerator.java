...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
            ...
            Employee e2 = new Employee("Aeriell", "McNee", "amcnee1@google.es", LocalDate.of(2009, 01, 26), Gender.MALE, 56752);
            Employee e3 = new Employee("Sydney", "Symonds", "ssymonds2@hhs.gov", LocalDate.of(2010, 05, 17), Gender.MALE, 95313);
