...
public class SecurityService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String s) throws UsernameNotFoundException {
        ...
        // its a spring security user spring make authenticztion bvaseon s[rong structure , simmilar we did for MVC ( we need decribe autherities ( we did it in user priciple but here we do not have it _
